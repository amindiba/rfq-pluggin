...
class B2B_Procurement_Admin {
    ...
    public static function redirect_old_dashboard() {
        if (isset($_GET['page']) && $_GET['page'] === 'b2b-procurement') {
            wp_safe_redirect(admin_url('admin.php?page=b2b-dashboard'));
            exit;
        }
    }
    ...
    public static function register_menus() {
        ...
        $hidden = array(
            ...
            array('b2b-products', array('B2B_Product_Catalog_Admin', 'render_products')),
            array('b2b-product-add', array('B2B_Product_Catalog_Admin', 'render_product_form')),
            array('b2b-product-edit', array('B2B_Product_Catalog_Admin', 'render_product_form')),
            array('b2b-categories', array('B2B_Product_Catalog_Admin', 'render_categories')),
            array('b2b-category-add', array('B2B_Product_Catalog_Admin', 'render_category_form')),
            array('b2b-category-edit', array('B2B_Product_Catalog_Admin', 'render_category_form')),
        );
    ...
    public static function get_page_title() {
        $titles = array(
            ...
            'b2b-master-data' => 'اطلاعات پایه',
            'b2b-measurement-units' => 'واحدهای اندازه‌گیری',
            'b2b-geography' => 'جغرافیای ایران',
            'b2b-provinces' => 'استان‌ها',
            'b2b-cities' => 'شهرها',
            'b2b-products' => 'مدیریت محصولات',
            'b2b-product-detail' => 'جزئیات محصول',
            'b2b-product-create' => 'ایجاد محصول',
            'b2b-product-edit' => 'ویرایش محصول',
            'b2b-categories' => 'دسته‌بندی محصولات',
            'b2b-suppliers' => 'تامین‌کنندگان',
            'b2b-supplier-detail' => 'جزئیات تامین‌کننده',
            'b2b-rfqs' => 'درخواست‌های خرید',
            'b2b-rfq-create' => 'ایجاد درخواست خرید',
            'b2b-rfq-detail' => 'جزئیات درخواست خرید',
            'b2b-quotations' => 'پیشنهادات تامین‌کنندگان',
            'b2b-quotation-create' => 'ایجاد پیشنهاد',
            'b2b-quotation-detail' => 'جزئیات پیشنهاد',
            'b2b-pos' => 'سفارشات خرید',
            'b2b-po-detail' => 'جزئیات سفارش خرید',
